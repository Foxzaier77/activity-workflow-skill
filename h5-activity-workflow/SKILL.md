...
Output a competitor analysis report in the user's Notion when Notion access is available. If Notion is unavailable, output a Markdown report that can be pasted into Notion. The report should include:

- Screenshot index and category summary.
- Activity overview.
- Mechanism breakdown.
- Numeric and reward analysis.
- Content and copywriting analysis.
- Visual and interaction design analysis.
- Strengths and weaknesses.
- Transferable learnings for the user's activity.
- Risks, unknowns, and follow-up questions.
- Recommendations for the current activity plan.
